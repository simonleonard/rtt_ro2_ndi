...
public:
  ...
  rtt_ros2_ndi( const std::string& name ) :
    ...
    serial(io_context),
    configure_sensor( "configureSensor", &rtt_ros2_ndi::configureSensor, this, RTT::ClientThread ){
